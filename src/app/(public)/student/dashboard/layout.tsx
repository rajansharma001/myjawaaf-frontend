  ...
  return (
    <div className="w-full flex flex-col justify-start items-center">
      ...
      <div className="W-full lg:w-[80%] md:w-[90%] flex flex-col gap-10">
        ...
        <div className="w-full flex flex-col lg:flex-row md:flex-row justify-center lg:py-10 md:py-6 py-2 gap-3">
          <div className="w-full lg:w-4/12 md:w-4/12 flex flex-col gap-2 border-1 border-gray-300 rounded-sm p-6  shadow-2xl shadow-inherit  text-[13px] capitalize font-semibold text-gray-500">
            <Link
