...
const UpdateEnroll = ({
  ...
  const getEnroll = async () => {
    const res = await fetch(
      `${process.env.NEXT_PUBLIC_API_URL}/auth/enroll/get-enrolled/${enrollId}`,
      {
        method: "GET",
        credentials: "include",
      }
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const res = await fetch(
        `${process.env.NEXT_PUBLIC_API_URL}/auth/enroll/update-enrolled/${enrollId}`,
        {
          method: "PATCH",
          credentials: "include",
          body: form,
        ...
        {loading ? (
          ...
          <div className="w-full ">
            ...
            <form onSubmit={handleSubmit} className="flex flex-wrap gap-2">
              ...
              <div className="flex flex-col w-full">
                <Image
                  src={`http://localhost:4000/${formData.receipt}`}
                  alt=""
                  width={150}
                  height={150}
                />
